...
import 'package:dist_perf/backend/backend.dart';
...
import 'car_driving2_model.dart';
export 'car_driving2_model.dart';

class CarDriving2Widget extends StatefulWidget {
  const CarDriving2Widget({Key? key}) : super(key: key);

  @override
  _CarDriving2WidgetState createState() => _CarDriving2WidgetState();
}

class _CarDriving2WidgetState extends State<CarDriving2Widget>
  ...
  void initState() {
    ...
    _model = createModel(context, () => CarDriving2Model());
  ...
  Widget build(BuildContext context) {
    String low = (map[map.keys.elementAt(5)].split(" "))[0];
    String high = (map[map.keys.elementAt(5)].split(" "))[2];
